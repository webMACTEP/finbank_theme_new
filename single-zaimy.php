...
<!--                            <div class="card__like d-flex align-items-center">
                   ...
                   <div class="credits__view-img">
                       ...
                       <div class="credits__view-buttons d-flex justify-content-center py-3 py-sm-4">
                           ...
                           <?php if( reclink($ID)):?> 
                            ...
                            <?php else: ?>
                                <a href="#" class="btn btn-light mx-3 <?if($apply_now){ ?> apply_now_btm <? }else {?>out_exit_link<? } ?>"
       ...
       <? if($featured_posts): ?>
            ...
            <? get_template_part( 'all_template/similar_list', null, ['TITLE' => 'Похожие займы', 'DATA' => $featured_posts]); ?>
                   ...
                   <div class="horizontal__scroll">
                       <div class="horizontal__scroll-container">
                           <?php if(have_rows('product_about_tabs', $ID)): ?>
                                <button data-target="about" data-parent="pageNav" class="nav-link btn-pageNav active">О займе</button>
                           ...
                           <div class="sidebar__header sidebar__section p-4">
                               ...
                               <div class="row">
                                   <div class="col-12 sidebar__container">
                                       ...
                                       <? if(get_field('z_organization_phone')): ?>
                                           <div class="sidebar__field mb-3">
                                       ...
                                       <? if(get_field('z_organization_email')): ?>

                                           <div class="sidebar__field mb-3">
                                               <div class="sidebar__field-title">Электронная почта</div>
                                               <div class="sidebar__field-content"><a href="mailto:<?php echo the_field('z_organization_email') ?>"><?php echo the_field('z_organization_email') ?></a></div>
                                           </div>
               ...
               <div class="col-12 col-md-9 col-lg-8 order-md-1">
                    ...
                    <div id="about" class="section">
                       <div class="section__header d-flex justify-content-between align-items-center">
                           <h2 class="title mb-4">О займе</h2>
                       </div>
...
<!--                    --><?php //= get_template_part( 'all_template/other_offers_list', null, $other_products); ?>
<!--                </div>-->
<!--           </div>-->
