<?php
/*
 * Template Name: Zaimy Личный кабинет
...
<main class="zaimy-new">
    ...
    <div class="container">
        ...
        <div class="credits__view section">
            ...
            <h1 class="credits__view-title mb-1 mb-xl-4 heads-lk active">Личный кабинет в <?php echo $parent_title ?></h1>
                    ...
                    <div class="forline">
                        <ul class="sidebar__menu">
                            ...
                            <?php if (get_field('about_lk', $data_source_id)) : ?>
                                ...
                                <li>
                                    <a href="<?php echo esc_url($parent_permalink); ?>lichnyy-kabinet/" class="item-lk active">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
