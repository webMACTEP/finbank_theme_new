    ...
    <div class="page__wrapper">
            ...
            <div class="container">
                <div class="sidebar sidebar-nav mb-4 p-4 order-md-2">
                    <div class="forline">
                        ...
                        // Предполагается, что $current_url уже определён или его можно получить так:
                        $current_url = get_permalink($current_page_id);
                        ?>
                        <ul class="sidebar__menu">
                            <li>
                                <a href="#content-about" class="item-about active">
                            ...
                            <?php if (get_field('supp_details', $current_page_id)) : ?>
                                <li>
                                    <a href="<?= esc_url($current_url); ?>goryachaya-liniya/" class="item-hotline">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <?php if (get_field('about_lk', $current_page_id)) : ?>
                                <li>
                                    <a href="<?= esc_url($current_url); ?>lichnyy-kabinet/" class="item-lk">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li>
                                <a href="<?php echo esc_url(trailingslashit(get_permalink()) . 'comments'); ?>">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <?php if (get_field('about_contacts', $current_page_id)) : ?>

                                <li>
                                    <a href="<?= esc_url($current_url); ?>kontakty/" class="item-contacts">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <?php if (get_field('tab_promo', $current_page_id)) : ?>
                                <li>
                                    <a href="<?= esc_url($current_url); ?>promokody-skidki/" class="item-promo">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="container">
            <div class="row section">
                <!-- sidebar -->
                <div class="col-12 col-md-3 col-lg-4 order-md-2">
                    <div class="top mb-5 mb-md-0">
                        <div class="new_dt sidebar sidebar-nav mb-4 p-4 order-md-2">
                            <div class="forline">
                                            ...
                                            <div class="sidebar__field-content">
                                                ...
                                                <?php else: ?>
                                                    <a href="#"
                                                        ...
                                                        onclick="<?php echo (get_metrika_for_detail_page(get_field('card_bank_link', $ID))); ?> return true;">
                                                        <?php echo esc_html(get_field('z_organization_site', $ID)); ?>
                                                    </a>
                                                <?php endif; ?>
                ...
                <div id="content-about" class="content-block content-about col-12 col-md-9 col-lg-8 order-md-1 active">
                    ...
                    <!-- terms -->
                    <?php
                    // Проверяем, есть ли вообще хотя бы один из нужных repeater-полей
                    $has_terms      = have_rows('product_tar_0', $ID);
                    $has_require    = have_rows('product_tar_2', $ID);
                    $has_issues     = have_rows('product_tar_3', $ID);
                    $has_contacts   = have_rows('product_tar_4', $ID);
                    $has_documents  = have_rows('product_tar_5', $ID);

                    if ($has_terms || $has_require || $has_issues || $has_contacts || $has_documents): ?>
                        <div id="tariffs" class="section">
                            <div class="section__header mb-4 d-flex justify-content-between align-items-center">
                                <h2 class="title mb-0">Условия оформления займа в <?php the_title(); ?></h2>
                            </div>
                            <div class="tariffs__list">
                                ...
                                <?php
                                // Номер активного блока (первый попавшийся) — понадобится для присвоения класса "active"
                                    ...
                                    <div class="item active">
                                        ...
                                        ?>
                                            <div class="tariffs__list-item">
                                                <div class="row">
                                                    <div class="tariffs__list-title col-4"><?php echo esc_html($title); ?></div>
                                                    <div class="tariffs__list-description col-8"><?php echo ($text); ?></div>
                                                </div>
                                            </div>
                                        <?php endwhile; ?>
                                    </div>
                                    <?php $first_active_index++; ?>
                                <?php endif; ?>

                                <?php if ($has_require): ?>
                                    <div class="item <?php echo ($first_active_index === 0) ? 'active' : ''; ?>">
                                    ...
                                    <div class="item <?php echo ($first_active_index === 0) ? 'active' : ''; ?>">
                                        ...
                                        ?>
                                            <div class="tariffs__list-item files">
                                                <div class="row">
                                                    <?php if ($file): ?>
                                                        <a target="_blank" href="<?php echo esc_url($file); ?>" class="tariffs__list-title col-12">
                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                                ...
                                                                <path d="M21 15V16.2C21 17.8802 21 18.7202 20.673 19.362C20.3854 19.9265 19.9265 20.3854 19.362 20.673C18.7202 21 17.8802 21 16.2 21H7.8C6.11984 21 5.27976 21 4.63803 20.673C4.07354 20.3854 3.6146 19.9265 3.32698 19.362C3 18.7202 3 17.8802 3 16.2V15M17 10L12 15M12 15L7 10M12 15V3"
                                                                    stroke="#14B8AD" stroke-width="1.5" stroke-linecap="round"
                                ...
                                ?>
                                    <div class="item p-4">
                                        <div class="head">
                                            ...
                                            <?php if (reclink($ID)): ?>
                                                <span
                                                    class="btn btn-primary link-data"
                                                    data-link="<?= esc_attr($card_bank_link); ?>"
                                                    onclick="<?php echo (get_metrika_for_detail_page($card_bank_link)); ?> return true;">
                                                    Подробнее
                                                </span>
                                ...
                                <form id="quizForm">
                                    ...
                                    <div class="quiz-question" data-question="13">
                                        ...
                                        <div class="button-group" style="margin-top: 20px;">
                                            ...
                                            <button type="button" class="next-btn" onclick="ym(35020350,'reachGoal','quiz'); return true;">Показать результат</button>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div class="section">
                        ...
                        <div class="additional-comments">
                            ...
                            ?>
                            <button id="showMoreComments" class="btn btn-outline-gray btn-block mt-3 mb-5">Показать ещё</button>
                                                ...
                                                <div class="card-container p-3">
                                                    <div class="card__header mb-2 d-flex">
                                                        ...
                                                        <div class="card__header-title"><a href="<?php echo the_permalink() ?>"> <?php
                                                                                                                                    $alter_title2 = get_field('alter_title');
                            ...
                            <div class="horizontal__scroll row">
                                <div class="horizontal__scroll-container">
                                   ...
                                   <?php echo the_field('bank_logo', $bank_choise_rel) ?>"
                                                        ...
                                                        <div class="card__header-title"><a href="<?php echo the_permalink() ?>"> <?php
                                                                                                                                    $alter_title3 = get_field('alter_title');
                                            ...
                                            <div class="card card__vertical size4 offer h-100">
                                                <div class="card-container p-3">
                                                    <div class="card__header mb-2 d-flex">
                                                        ...
                                                        <div class="card__header-title"><a href="<?php echo the_permalink() ?>"> <?php
                                                                                                                                    $alter_title4 = get_field('alter_title');
                                            ...
                                            <div class="card card__vertical size4 offer h-100">
                                                <div class="card-container p-3">
                                                    <div class="card__header mb-2 d-flex">
                                                        ...
                                                        <div class="card__header-title"><a href="<?php echo the_permalink() ?>"> <?php
                                                                                                                                    $alter_title5 = get_field('alter_title');
                                                                                                                                    $alter_title5 = get_field('alter_title');
...
<script src="<?php echo get_template_directory_uri(); ?>/js/comments-more.js"></script>
<script>
