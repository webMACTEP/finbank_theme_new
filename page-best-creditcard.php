                                    ...
                                    <?php endif; ?>
                                          ...
                                          <div class="best1_offer_params">
                                            ...
                                            <div class="best1_offer_param">
                                              ...
                                              <div class="best1_offer_param_value"><?php $field = get_field('card_period', $best_id); echo $field['label'] ?></div>
                                            </div>
                                            <div class="best1_offer_param">
                                            ...
                                            <div class="best1_offer_param">
                                              ...
                                              <div class="best1_offer_param_value">от <?php $field = get_field('card_stavka', $best_id); echo $field ?>%</div>
                                            </div>                                           
                                          </div>                                          
