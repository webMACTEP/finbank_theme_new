	...
	<div class="page__heading mb-sm-4 special_hide">
		<div class="container">
			<div class="page__heading-top d-flex justify-content-between align-items-center">
				<div>
					<h1 class="page__heading-title mb-0">Лучшие предложения по кредитным картам</h1>
				</div>
			...
			<div class="page__nav-container nav-tabs">
				<div class="horizontal__scroll">
					<div class="horizontal__scroll-container">
						...
						<a href="<?php echo get_page_link(5339) ?>" class="nav-link active">Кредитные карты</a>
				...
				<div class="col-12">
					<div class="credits__list">
						...
						<div class="d-flex flex-wrap justify-content-between align-items-center mt-0 mt-md-5 mt-lg-0 mb-3">
							<div class="h2 mt-5 mb-4 mt-md-0 mb-md-0 special_hide"><span class="variants_count"><?= count(get_field('best-products')) ?></span> лучших кредитных карт</div>
							<div class="credits__list-dropdown dropdown mb-3 mb-md-0 col-12 col-md-5 col-lg-3 px-0">
								<select name="" class="styledSelect best1-order-select">
									...
									<option value="card_cred_limit" <?= ($order == 'card_cred_limit') ? $selected : ''; ?>>По кредитному лимиту</option>
									<option value="card_stavka" <?= ($order == 'card_stavka') ? $selected : ''; ?>>По процентной ставке</option>
								</select>
							</div>
						</div>
						...
						<div class="best1_offers">
							...
							switch ($order) {
								...
								case 'views':
									...
									$args['order'] = 'DESC';
									break;
								case 'card_cred_limit':
									$args['meta_key'] = 'card_cred_limit';
									$args['orderby'] = array('meta_value_num' => 'desc', 'name' => 'desc');
									$args['order'] = 'DESC';
									break;
								case 'card_stavka':
									$args['meta_key'] = 'card_stavka';
									...
									<div class="best1_offer position-relative" style="order: <?= $io; ?>">
										...
										<div class="best1_offer_params">
											<div class="best1_offer_param">
												<div class="best1_offer_param_label">Лимит</div>
												<div class="best1_offer_param_value"><?= get_field('card_cred_limit', $best_id) ?> ₽</div>
											</div>
											<div class="best1_offer_param">
												<div class="best1_offer_param_label">Без %</div>
												<div class="best1_offer_param_value"><?php $field = get_field('card_period', $best_id);
																						echo $field['label'] ?></div>
											</div>
											<div class="best1_offer_param">
												<div class="best1_offer_param_label">Кэшбэк</div>
												<div class="best1_offer_param_value"><?= get_field('card_cashback', $best_id); ?></div>
											</div>
											<div class="best1_offer_param">
												<div class="best1_offer_param_label">Ставка</div>
												<div class="best1_offer_param_value">от <?php $field = get_field('card_stavka', $best_id);
																						echo $field ?>%</div>
											</div>
										</div>
