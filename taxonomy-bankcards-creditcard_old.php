					...
					<div class="col-12 col-md-6 col-lg-3 col-xl-4 order-1">
						<div class="range">
							<div class="d-flex justify-content-between">
								...
								<input type="text" class="range__value cred_limit" value="<?php echo $cred_limit ?>" min="0" max="10000000">
							</div>
							<input class="range__input" name="cred_limit" type="range" min="0" max="10000000" value="<?php echo $cred_limit ?>">
					...
					<div class="col-12 col-md-6 col-lg-3 col-xl-4 order-2">
						<div class="range">
							<div class="d-flex justify-content-between">
								...
								<input type="text" class="range__value cred_trat" value="<?php echo $cred_day_period ?>" min="0" max="8000">
							</div>
							<input class="range__input" name="cred_day_period" type="range" min="0" max="8000" value="<?php echo $cred_day_period ?>">
						</div>
					</div>
										...
										<div class="filter mt-3 mb-2">
											...
											<div class="filter__section" id="collist_<?= $cat->term_id; ?>">
												...
												<?php while ($query->have_posts()) {
													$query->the_post();
													$counter_col += 1; ?>
													<a class="filter__btn <?php if ($counter_col > 4): echo 'coll_li coll__hidden';
																			endif; ?><?php if ($current_id == get_the_ID()) echo ' active_post'; ?>" href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
												<?php } ?>
											</div>
										</div>
				...
				<div class="col-12 col-lg-8 order-lg-1">
					<div class="credits__list">
						...
						<div class="d-flex flex-wrap justify-content-between align-items-center mt-0 mt-md-5 mt-lg-0 mb-3">
							<div class="mt-5 mb-4 mt-md-0 mb-md-0"><span class="variants_count"><?php //echo $wp_query->found_posts;
																								?></span> вариантов</div>
							...
							<div class="reviews__item">
								...
								<div class="reviews__item-footer">
									<div class="reviews__author d-flex align-items-center mt-3">
										<div class="reviews__author-img mr-3"><img src="<?php echo get_avatar_url($comment, array(
																							'size' => 60,
																							'default' => 'identicon',
