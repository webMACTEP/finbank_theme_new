<?php
/*
 * Template Name: Zaimy Горячая линия
...
<main class="zaimy-new">
    ...
    <div class="container">
        ...
        <div class="credits__view section">
            ...
            <h1 class="credits__view-title mb-1 mb-xl-4 heads-lk active">Горячая линия <?php echo $parent_title ?></h1>
                        ...
                        <ul class="sidebar__menu">
                            ...
                            <?php if (get_field('supp_details', $data_source_id)) : ?>
                                <li>
                                    ...
                                    <a href="<?php echo esc_url($parent_permalink); ?>goryachaya-liniya/" class="active">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="tariffs-cards">
                                ...
                                ?>
                                    <div class="item p-4">
                                        <div class="head">
                                            <?php
                                            // Получаем URL и alt-текст логотипа организации из родительской записи
                                            $logo_url = get_field('z_organization_logo', $data_source_id);
                                            $logo_id  = get_field('z_organization_logo', $data_source_id, false);
                                            $logo_alt = get_post_meta($logo_id, '_wp_attachment_image_alt', true);
                                            ?>
                                        ...
                                        <div class="info">
                                            <div class="info-item">
                                                ...
                                                <div class="info-text"><?php echo esc_html($summa); ?></div>
                                            </div>
                                            <div class="info-item">
                                                <div class="info-title">Срок</div>
                                                <div class="info-text"><?php echo esc_html($time); ?></div>
                                            </div>
                                            <div class="info-item">
                                                <div class="info-title">ПСК</div>
                                                <div class="info-text"><?php echo esc_html($psk); ?></div>
                                            </div>
                                        </div>
