...
<main>
    <div class="container">
            ...
            <div class="row">
                <div class="col-12 col-md-7">
                    ...
                    <div class="credits__view-meta d-flex flex-wrap flex-xl-nowrap align-items-center">
                        <div class="credits__view-bank mt-3 mt-xl-0 mr-3">
                            <?php $bank_id = get_field('product_bank', $ID); ?>
                    ...
                    <div class="row my-2 my-sm-4 mb-md-0 credits__view-block">
                        <div class="col-6 col-md-4">
                            <div class="credits__view-field field d-flex mt-3">
                                <div class="field__img mr-2"><img src="<?php bloginfo('template_url'); ?>/img/icon__speed.png" alt=" Максимальная сумма"></div>
                                <div class="field__content">
                                    <div class="field__content-title"><?= get_field_object('credit_max_sum', $ID)['label']; ?></div>
                                    <div class="field__content-num"><?= number_format(get_field('credit_max_sum', $ID), 0, '.', ' '); ?> ₽</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-4">
                            <div class="credits__view-field field d-flex mt-3">
                                <div class="field__img mr-2"><img src="<?php bloginfo('template_url'); ?>/img/icon__fire.png" alt=" кредитная ставка"></div>
                                <div class="field__content">
                                    <div class="field__content-title">% ставка</div>
                                    <div class="field__content-num">От <?php echo the_field('credit_stavka', $ID) ?>%</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-4">
                            <div class="credits__view-field field d-flex mt-3">
                                <div class="field__img mr-2"><img src="<?php bloginfo('template_url'); ?>/img/icon__hand.png" alt="Возраст от"></div>
                                <div class="field__content">
                                    <div class="field__content-title">Возраст</div>
                                    <div class="field__content-num">От <?= get_field('credit_oldness', $ID) ?> <?= YearTextArg(get_field('credit_oldness', $ID)) ?></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-4">
                            <div class="credits__view-field field d-flex mt-3">
                                <div class="field__img mr-2"><img src="<?php bloginfo('template_url'); ?>/img/icon__off.png" alt="Минимальная сумма кредита"></div>
                                <div class="field__content">
                                    <div class="field__content-title"><?= get_field_object('credit_min_sum', $ID)['label']; ?></div>
                                    <div class="field__content-num">
                                        <?php $card_period = get_field('credit_min_sum', $ID);
                                        echo number_format($card_period, 0, '.', ' '); ?> ₽
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-4">
                            <div class="credits__view-field field d-flex mt-3">
                                <div class="field__img mr-2"><img src="<?php bloginfo('template_url'); ?>/img/icon__cashback.png" alt="Срок кредита"></div>
                                <div class="field__content">
                                    <div class="field__content-title">Срок кредита</div>
                                    <div class="field__content-num">до <?php $field = get_field('credit_period');
                                                                        //$value = $field['value'];
                        ...
                        <div class="col-6 col-md-4">
                            <div class="credits__view-field field d-flex mt-3">
                                ...
                                <div class="field__content">
                                    ...
                                    <div class="field__content-num"><?php echo the_field('credit_answer', $ID) ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-5">
                    <div class="credits__view-img">
                        ...
                        <img src="<?php echo get_field('card_logo', $ID) ?>" alt="<?php echo the_title() ?>">
                        <div class="credits__view-buttons d-flex justify-content-center py-3 py-sm-4">
                            ...
                            <?php else: ?>
                                <a href="#" class="<? if ($apply_now) { ?> apply_now_btm <?php } else { ?>out_exit_link<?php } ?> btn btn-light mx-3 " onclick="<?= get_metrika_for_detail_page(get_field('card_bank_link', $ID)) ?> return true;">Оформить сейчас</a>
                            <?php endif; ?>
        ...
        <?php if ($_GET['danil_test']): ?>

            <?php get_template_part('all_template/podborki__list', null, 'кредитов'); ?>
        ...
        get_template_part('all_template/similar_list', null, ['TITLE' => 'Похожие кредиты', 'DATA' => $featured_posts]);
                    ...
                    <div class="horizontal__scroll">
                        <div class="horizontal__scroll-container">
                            <?php if (have_rows('product_about_tabs', $ID)): ?>
                                <button data-target="about" data-parent="pageNav" class="nav-link btn-pageNav active">О кредите</button>
        ...
        <div class="container">
                ...
                <div class="col-12 col-md-3 col-lg-4 order-md-2">
                    <div class="sticky-top sticky-top-withnav top mb-5 mb-md-0">
                                ...
                                <div class="d-flex align-items-center mb-4">
                                    <div class="bank__item-img mr-3">
                                        <a href="<?php the_permalink($bank_id); ?>">
                                           ...
                                           <?php echo get_post_meta(get_field('bank_logo', $bank_id, false), '_wp_attachment_image_alt', true); ?>">
                                        </a>
                                    </div>
                                    <div class="bank__item-content">
                                        ...
                                        <div class="card__header-info d-flex align-items-center">
                                            ...
                                            <div class="position-relative card__icon d-flex align-items-center mr-3">
                                                <div class="mr-2"><a href="<?php the_permalink($bank_id) ?>#comments" data-target="comments" class="stretched-link"><svg width="18" height="17" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 17" xml:space="preserve">
                                                            <use xlink:href="<?php bloginfo('template_url'); ?>/img/icons.svg#commentLine" x="0" y="0"></use>
                                                        </svg></a></div>
                                                <?php $comments_count = wp_count_comments($bank_id);
                                       ...
                                       <div class="col-6"-->
                                        <div class="sidebar__field mb-3">
                                            ...
                                            <div class="sidebar__field-content">
                                                ...
                                                <?php else: ?>
                                                    <a class="off_site_link <? if ($apply_now) { ?> apply_now_btm <?php } else { ?>out_exit_link <? } ?>"
                                                        onclick="<?= get_metrika_for_detail_page(get_field('card_bank_link', $ID)) ?> return true;">
                                                        <?= get_field('bank_email', $bank_id);  ?>
                                                    </a>
                                                <?php endif; ?>
                                        ...
                                        <?php if (get_field('bank_phone', $bank_id)): ?>
                                            <div class="sidebar__field mb-3">
                                        ...
                                        <?php if (get_field('bank_e_mail_long', $bank_id)): ?>
                                            <div class="sidebar__field mb-3">
                                        ...
                                        <div class="sidebar__field mb-3">
                                            ...
                                            <?php if (reclink($ID)): ?>
                                                <a href="<?php echo the_field('card_bank_link', $ID) ?>" target="_blank"
                                                    onclick="<?= get_metrika_for_detail_page(get_field('card_bank_link', $ID)) ?> return true;" class="btn btn-primary">Оформить сейчас</a>
                                            <?php else: ?>
                                                <a href="#" class="btn btn-primary <? if ($apply_now) { ?> apply_now_btm <?php } else { ?>out_exit_link <? } ?>"
                        ...
                        <div class="article__news mb-5 p-4">
                            <h3 class="article__news-title article__container-title mb-3">Статьи о кредитах</h3>
                            <?php
                            $args = array(
                                'posts_per_page' => 5,
                                'post_type' => 'post',
                    ...
                    <?php if (have_rows('product_about_tabs', $ID)):
                        ...
                        <div id="about" class="section">
                            <div class="section__header d-flex justify-content-between align-items-center">
                                <h2 class="title mb-4">О кредите</h2>
                            </div>
            ...
            if ($other_products): ?>
                ...
                <div id="offers" class="section">
                    <?php get_template_part('all_template/similar_list_with_offer_link', null, ['TITLE' => 'Другие предложения ', 'DATA' => $other_products]); ?>
                </div>
