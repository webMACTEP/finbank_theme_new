                ...
                <div class="col-12 col-md-5">
                    <div class="credits__view-img">
                        ...
                        <div class="credits__view-buttons d-flex justify-content-center py-3 py-sm-4">
                            ...
                            <?php else: ?>
                                <a href="#" class="<? if ($apply_now) { ?> apply_now_btm <? } else { ?>out_exit_link<? } ?> btn btn-light mx-3 " onclick="<?= get_metrika_for_detail_page(get_field('card_bank_link', $ID)) ?> return true;">Оформить сейчас</a>
                            <?php endif; ?>
                ...
                <div class="col-12 col-md-3 col-lg-4 order-md-2">
                    <div class="sticky-top sticky-top-withnav top mb-5 mb-md-0">
                                ...
                                <div class="d-flex align-items-center mb-4">
                                    <div class="bank__item-img mr-3">
                                        <a href="<?php the_permalink($bank_id); ?>">
                                           ...
                                           <? echo get_post_meta(get_field('bank_logo', $bank_id, false), '_wp_attachment_image_alt', true); ?>">
                                        </a>
                                    </div>
                        ...
                        <div class="article__news mb-5 p-4">
                            <div class="article__news-title article__container-title mb-3">Статьи о кредитах</div>
                            <?php
                            $args = array(
                                'posts_per_page' => 5,
                                'post_type' => 'post',
