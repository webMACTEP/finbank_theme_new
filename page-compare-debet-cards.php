...
<?php 
/*
$prods[0] = $_SESSION['debet_cards'][0]; 
$prods[1] = $_SESSION['debet_cards'][1]; 
$prods[2] = $_SESSION['debet_cards'][2]; 
$prods[3]= $_SESSION['debet_cards'][3]; 
*/
$prods = [];
foreach ($_SESSION['debet_cards'] ?? [] as &$prod) {
    $prods[] = $prod;
}

$debet_count = count($prods);
?>

<main data-type="debetcard">
	<div class="container">
	...
	<div class="page__heading mb-sm-4">
	    <div class="container">
	        <div class="page__heading-top d-flex justify-content-between align-items-center">
	            <div>
	                <h1 class="page__heading-title mb-0">Сравнение дебетовых карт</h1>
	            </div>
	            <div class="page__heading-icon"><img src="<?php bloginfo('template_url'); ?>/img/icon__title-hand.png" alt="Сравнение дебетовых карт"></div>
	        </div>
	    </div>
	</div>
	<!-- / page header -->
	        ...
	        <div class="page__nav-container nav-tabs">
	            <div class="horizontal__scroll">
	                <div class="horizontal__scroll-container">
	                    <a href="<?php echo get_term_link(7, '') ?>" class="nav-link">Все дебетовые карты</a>
	                    <a href="<?php echo get_page_link(1503) ?>" class="nav-link tax-reviews" data-tax="debetcard">Отзывы</a>
	                    <a href="<?php echo get_page_link(157) ?>" class="nav-link">Калькулятор</a>
	                    <a href="<?php echo get_category_link(13) ?>" class="nav-link">Статьи</a>
	                    <a href="<?php echo get_page_link(1548) ?>" class="nav-link active">сравнить</a>
	                </div>
	            </div>
	        </div>
	    </div>
	        ...
	        <div class="tags__main mb-5 pb-2 ">
	            <div class="horizontal__scroll">
	                <div class="horizontal__scroll-container">
	                    ...
	                    <a href="<?php echo get_page_link(1548) ?>" class="tag__item active"><span class="tag__item-title">Дебетовые карты 
	                    ...
	                    <a href="<?= get_term_link(7, ''); ?>" class="tag__item tag__item__more">+ Добавить ещё</a>
	                </div>
	            </div>
	        </div>
	    </div>
