...
<?php 
/*
$prods[0] = $_SESSION['kredity'][0]; 
$prods[1] = $_SESSION['kredity'][1]; 
$prods[2] = $_SESSION['kredity'][2]; 
$prods[3] = $_SESSION['kredity'][3]; 
*/

$prods = [];
foreach ($_SESSION['kredity'] ?? [] as &$prod) {
    $prods[] = $prod;
}


$kredity_count = count($prods);

?>

<main data-type="kredity">
	<div class="container">
	...
	<div class="page__heading mb-sm-4">
	    <div class="container">
	        <div class="page__heading-top d-flex justify-content-between align-items-center">
	            <div>
	                <h1 class="page__heading-title mb-0">Сравнение кредитов</h1>
	            </div>
	            <div class="page__heading-icon"><img src="<?php bloginfo('template_url'); ?>/img/icon__title-hand.png" alt="Сравнение кредитов"></div>
	        </div>
	    </div>
	</div>
	<!-- / page header -->
	        ...
	        <div class="page__nav-container nav-tabs">
	            <div class="horizontal__scroll">
	                <div class="horizontal__scroll-container">
	                    <a href="<?php echo get_post_type_archive_link('kredity') ?>" class="nav-link">Все кредиты</a>
	                    <a href="<?php echo get_page_link(1503) ?>" class="nav-link tax-reviews" data-tax="kredity">Отзывы</a>
	                    <a href="<?php echo get_page_link(149) ?>" class="nav-link">Калькулятор</a>
	                    <a href="<?php echo get_category_link(18) ?>" class="nav-link">Статьи</a>
	                    <a href="<?php echo get_page_link(1552) ?>" class="nav-link active">сравнить</a>
	                </div>
	            </div>
	        </div>
	    </div>
	        ...
	        <div class="tags__main mb-5 pb-2 ">
	            <div class="horizontal__scroll">
	                <div class="horizontal__scroll-container">
	                    ...
	                    <a href="<?php echo get_page_link(1552) ?>" class="tag__item active"><span class="tag__item-title">кредиты 
	                    ...
	                    <a href="/kredity/" class="tag__item tag__item__more">+ Добавить ещё</a>
	                </div>
	            </div>
	        </div>
	    </div>
	                ...
	                <div class="compare__list-container">   
	                    ...
	                    <div class="compare__list-header">
	                        <div class="compare__row">
	                            <?php if($prods[0] != ''): ?>
	                            <!-- item -->
	                            <?php $bank_id = get_field('product_bank', $prods[0]); ?>
	                            ...
	                            <?php if($prods[1] != ''): ?>
	                            <!-- item -->
	                            <?php $bank_id = get_field('product_bank', $prods[1]); ?>
	                            ...
	                            <?php if($prods[2] != ''): ?>
	                            <!-- item -->
	                            <?php $bank_id = get_field('product_bank', $prods[2]); ?>
	                            ...
	                            <?php if($prods[3] != ''): ?>
	                            <!-- item -->
	                            <?php $bank_id = get_field('product_bank', $prods[3]); ?>
