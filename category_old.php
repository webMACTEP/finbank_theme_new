            ...
            <div class="article__container">
                ...
                <div class="article__container-right d-none d-xl-block order-xl-3">
                    <div class="sticky-top">
                        ...
                        <div class="article__news mb-5">
                            ...
                            <div class="article__news-title article__container-title mb-3">
                                Популярные <?php echo $popular_name ?>
                            </div>
                            <?php
                            $args = array(
                                'posts_per_page' => 5,
                                        ...
                                        <div class="article__news-body">
                                            ...
                                            <div class="d-flex align-items-center mt-2">
                                                <div class="card__icon d-flex align-items-center mr-3">
                                                    <div class="mr-2">
                                                        <svg width="19" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20.5 17.2">
                        ...
                        <!-- best offers -->
                        <?php
                        $featured_posts = get_field('cat_best_prod', 'category_' . $current_cat_id);
                        if ($featured_posts): ?>
                ...
                <div class="article__container-center order-xl-2">
                    ...
                    <div class="<?= $current_cat_id ?>" id="response-cred-card">
                        ...
                        // Единственное изменение — добавляем 50 записей:
                        $args = array(
                            'post_type'      => 'post',
                            'cat'            => $current_cat_id,
                            'orderby'        => 'date',
                            'order'          => 'DESC',
                            'paged'          => $paged,
                            'posts_per_page' => 70, // <-- выводим 70 записей
                        );
                        ...
                        ?>
                                                            ...
                                                            <div class="offer__item">
                                                                <div class="offer__item-header">
                                                                    ...
                                                                    <div class="d-flex align-items-center mt-2">
                                                                        ...
                                                                        <div class="position-relative card__icon d-flex align-items-center mr-3">
                                                                            <div class="mr-2">
                                                                                <a href="<?php the_permalink(get_the_id()) ?>#comments" data-target="comments" class="stretched-link">
                                                                                    <svg width="18" height="17" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 17">
                                                                                        <use xlink:href="<?php bloginfo('template_url'); ?>/img/icons.svg#commentLine" x="0" y="0"></use>
                                                                                    </svg>
                                                                                </a>
                                                                ...
                                                                <?php
                                                                $loop_terms = wp_get_post_terms(get_the_ID(), 'bankcards', array('fields' => 'all'));
                                                                ...
                                                                <?php if ($loop_term_slug == 'debetcard'): ?>
                                                                    <div class="offer__item-body">
                                                                        ...
                                                                        <p class="txt3">Тип кешбэка - <?php
                                                                                                        $field = get_field('card_cashback_type');
                                                                                                        echo $field['label'];
                                                                                                        ?></p>
                                                                        <p class="txt3">Кешбэк - <?php
                                                    ...
                                                    <?php if ($post_type == 'kredity'): ?>
                                                        <div class="horizontal__scroll-item size3">
                                                            <div class="offer__item">
                                                                ...
                                                                <div class="offer__item-body">
                                                                    <p class="txt1">Срок кредита до <?php
                                ...
                                <?php if (($counter + 1) % 3 == 0): ?>
                                    ...
                                    $items = array(
                                        'cat_banner'   => $banner1['percent_in'],
                                        'cat_banner_2' => $banner2['percent_in'],
                                        'cat_banner_3' => $banner3['percent_in']
                                    );
                                    ?>
                                    ...
                                    ?>
                                        ...
                                        <div class="article__bnr-mob article__bnr d-block d-md-flex">
                                            <div class="article__bnr-img ml-md-2 order-md-2 text-center">
                                                <img src="<?= $img; ?>" alt="<?php echo $title ?>">
                                            </div>
                                        ...
                                        <!-- / banner -->
                                    <?php endif; ?>
                                <?php endif; // if(($counter+1) % 3 == 0) 
                                ?>

                                <div class="article__one">
                                    <!-- item header -->
                                    <div class="article__one-header">
                                        <div class="article__one-date">
                                    ...
                                    <div class="article__one-footer">
                                        ...
                                        <div class="card__icon d-flex align-items-center mr-3">
                                            <div class="mr-2">
                                                <svg width="17" height="12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 17.2 12.2">
                                                    <use xlink:href="<?php bloginfo('template_url'); ?>/img/icons.svg#share" x="0" y="0"></use>
                                                </svg>
                                            </div>
                                            <?php
                                            $shares = get_field('share_clicks');
                                            if ($shares == '') {
                                                echo '0';
                                            } else {
