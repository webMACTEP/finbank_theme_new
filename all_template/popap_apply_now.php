    ...
    <div class="check_popap popup_apply_now <?php if (wp_is_mobile()): ?> popup_apply_now-mob <?php else: ?> popup_apply_now-desktop <?php endif; ?>" style="display:none">
        <div class="out_exit">
            ...
            <div class="out_exit_body">
                ...
                ?>
                <div class="exit1_offer_param_label">
                    К сожалению, "<?php echo esc_html($title); ?>" больше не доступен для оформления на Finabank.
                    <br>Предлагаем ознакомиться с похожими предложениями.
                </div>
                                ...
                                <div class="slider__item" <?php if (!wp_is_mobile() && !$bank_choise_rel): ?>style="min-height: 280px" <?php endif; ?>>
                                    ...
                                    switch ($posttype) {
                                            ...
                                            <div class=" position-relative">
                                                <div class="exit1_offer_logo">
                                                    <img src="<?php $bank_choise_rel = get_field('product_bank', $bank_exit_id) ?>
                                                         <?php echo  get_field('bank_logo', $bank_choise_rel) ?>"
                                                    ...
                                                    <div class="exit1_offer_meta">
                                                        <div class="exit1_offer_name"><?php echo  get_the_title($bank_exit_id) ?></div>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <div class="card__rating d-flex align-items-center mr-3">
                                                                ...
                                                                <?php echo  get_field('ratings_average', $bank_exit_id); ?>
                                                            </div>
                                                            <div class="position-relative card__icon d-flex align-items-center mr-3">
                                                                <div class="mr-2"><a href="<?php the_permalink($bank_exit_id) ?>#comments" data-target="comments" class="stretched-link"><svg width="18" height="17" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 17" xml:space="preserve">
                                                                            <use xlink:href="<?php bloginfo('template_url'); ?>/img/icons.svg#commentLine" x="0" y="0"></use>
                                                                        </svg></a></div>
                                                                <?php $comments_count = wp_count_comments($bank_exit_id);
                                                ...
                                                <div class="exit1_offer_params">
                                                    <div class="exit1_offer_param">
                                                        ...
                                                        <div class="exit1_offer_param_value"><?php echo  get_field('credit_max_sum', $bank_exit_id) ?> ₽</div>
                                                    </div>
                                                    <div class="exit1_offer_param">
                                                        <div class="exit1_offer_param_label">% ставка</div>
                                                        <div class="exit1_offer_param_value"><?php echo  get_field('credit_stavka', $bank_exit_id); ?></div>
                                                    </div>
                                                    <div class="exit1_offer_param">
                                                        <div class="exit1_offer_param_label">Срок кредита</div>
                                                        <div class="exit1_offer_param_value">до <?php $field = get_field('credit_period', $bank_exit_id);
                                                                                                echo $field['label'] ?></div>
                                                    </div>
                                                </div>
                                                <div class="exit1_offer_button">
                                                    <?php if (get_field('card_bank_link', $bank_exit_id)): ?>
                                                        <a href="<?php echo  get_field('card_bank_link', $bank_exit_id) ?>" target="_blank"
                                                            class="btn btn-outline-primary btn-sm btn-block font-weight-normal exit1_offer_btn stretched-link"
                                                            onclick="<?php echo  get_metrika_for_popap_apply(get_field('card_bank_link', $bank_exit_id)); ?> return true;">Подробнее</a>
                                                    <?php else: ?>
                                                        <a href="<?php the_permalink($bank_exit_id); ?>" class="btn btn-outline-primary btn-sm btn-block font-weight-normal exit1_offer_btn stretched-link"
                                                            onclick="<?php echo  get_metrika_for_popap_apply(get_permalink($bank_exit_id)); ?> return true;">Подробнее</a>
                                                    <?php endif; ?>
                                        ...
                                        case 'bankcard':
                                                ...
                                                <div class=" position-relative">
                                                    ...
                                                    <div class="exit1_offer_params">
                                                        <div class="exit1_offer_param">
                                                            ...
                                                            <div class="exit1_offer_param_value">до <?php echo  get_field('non_pecent_money', $bank_exit_id) ?> ₽</div>
                                                        </div>
                                                        <div class="exit1_offer_param">
                                                            <div class="exit1_offer_param_label">% на остаток</div>
                                                            <div class="exit1_offer_param_value">до <?php echo  get_field('card_stavka_ostatok', $bank_exit_id); ?></div>
                                                        </div>
                                                        <div class="exit1_offer_param">
                                                            <div class="exit1_offer_param_label">Кешбэк</div>
                                                            <div class="exit1_offer_param_value"><?php $field = get_field('card_cashback', $bank_exit_id);
                                                                                                    echo $field['label'] ?></div>
                                                        </div>
                                                    </div>
                                                    <div class="exit1_offer_button">
                                            ...
                                            <?php } elseif ($termpost[0]->slug == 'creditcard') { ?>
                                                ...
                                                <div class=" position-relative">
                                                    <div class="exit1_offer_logo">
                                                        <img src="<?php $bank_choise_rel = get_field('bank_choise', $bank_exit_id) ?>
                                                                         <?php echo  get_field('bank_logo', $bank_choise_rel) ?>" alt="<?php echo get_post_meta(get_field('bank_logo', $bank_choise_rel, false), '_wp_attachment_image_alt', true); ?>">
                                                        <div class="exit1_offer_meta">
                                                            <div class="exit1_offer_name"><?php echo  get_the_title($bank_exit_id) ?></div>
                                                    ...
                                                    <div class="exit1_offer_params">
                                                        <div class="exit1_offer_param">
                                                            ...
                                                            <div class="exit1_offer_param_value"><?php echo  get_field('card_cred_limit', $bank_exit_id) ?> ₽</div>
                                                        </div>
                                                        <div class="exit1_offer_param">
                                                            <div class="exit1_offer_param_label">Без %</div>
                                                            <div class="exit1_offer_param_value"><?php $field = get_field('card_period', $bank_exit_id);
                                                                                                    echo $field['label'] ?></div>
                                                        </div>
                                                        <div class="exit1_offer_param">
                                                            <div class="exit1_offer_param_label">Ставка</div>
                                                            <div class="exit1_offer_param_value">от <?php echo  get_field('card_stavka', $bank_exit_id); ?>%</div>
                                                        </div>
                                                    </div>
                                                    <div class="exit1_offer_button">
                                                        <?php if (get_field('card_bank_link', $bank_exit_id)): ?>
                                        ...
                                        default: ?>
                                            ...
                                            <div class=" position-relative">
                                                <div class="exit1_offer_logo">
                                                    <img src="<?php echo  get_field('z_organization_logo', $bank_exit_id); ?>"
                                                ...
                                                <div class="exit1_offer_params">
                                                    <div class="exit1_offer_param">
                                                        ...
                                                        <div class="exit1_offer_param_value"><?php echo  get_field('z_sum', $bank_exit_id); ?> ₽</div>
                                                    </div>
                                                    <div class="exit1_offer_param">
                                                        <div class="exit1_offer_param_label">% ставка</div>
                                                        <div class="exit1_offer_param_value"><?php echo  get_field('z_stavka', $bank_exit_id); ?>%</div>
                                                    </div>
                                                    <div class="exit1_offer_param">
                                                        <div class="exit1_offer_param_label">Срок кредита</div>
                                                        <div class="exit1_offer_param_value">От <?php echo  get_field('z_time', $bank_exit_id); ?> дней</div>
                                                    </div>
                                                </div>
                                                <div class="exit1_offer_button">
                                                    <?php if (get_field('card_bank_link', $bank_exit_id)): ?>
                ...
                <div class="exit1_button">
                    ...
                    <?php if (get_field('card_bank_link') && !reclink(get_the_id())): ?>
                        <a onclick="ym(35020350,'reachGoal','NOREF_POPUP_close');" href="<?php echo  get_field('card_bank_link'); ?>" target="_blank" class="btn btn-outline-primary exit1_btn">Спасибо, не надо</a>
                    <?php endif; ?>
