...
<main class="zaimy-new">
    ...
    <div class="container">
        ...
        <div class="credits__view section">
            ...
            <h1 class="credits__view-title mb-1 mb-xl-4 heads-lk active">Промокоды, скидки в <?php echo $parent_title ?></h1>
    ...
    <div class="page__wrapper">
                ...
                <div class="sidebar sidebar-nav mb-4 p-4 order-md-2">
                    <div class="forline">
                        <ul class="sidebar__menu">
                            ...
                            <?php if (get_field('supp_details', $data_source_id)) : ?>
                                <li>
                            ...
                            <?php endif; ?>
                            <?php if (get_field('about_lk', $data_source_id)) : ?>
                            ...
                            <?php if (get_field('about_contacts', $data_source_id)) : ?>
                                <li>
                                    <a href="<?php echo esc_url($parent_permalink); ?>kontakty/" class="item-contacts">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <?php endif; ?>
                            <?php if (get_field('tab_promo', $data_source_id)) : ?>
                                <li>
                                    <a href="<?php echo esc_url($parent_permalink); ?>promokody-skidki/" class="item-promo active">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="container">
            <div class="row section">
                ...
                <!-- / sidebar -->
                <!-- page content -->
                <div id="content-promo" class="content-block content-promo col-12 col-md-9 col-lg-8 order-md-1 active">
                    <div class="section">
                        <div class="section__header d-flex justify-content-between align-items-center">
                            <h2 class="title mb-4"><?php echo the_field('promo_title', $parent_id) ?></h2>
                        </div>
                        <div class="items">
                            <?php while (have_rows('tab_promo', $parent_id)): the_row();
                    ...
                    <!-- tariffs-rows  -->
                    <?php if (have_rows('tarifs_new', $parent_id)): ?>
                        <div class="section">
                            <div class="section__header d-flex justify-content-between align-items-center">
                                <h2 class="title mb-4">Тарифы <?php echo $parent_title ?></h2>
                            </div>

                            <div class="tariffs-rows">
                                <?php while (have_rows('tarifs_new', $parent_id)): the_row();
                                    $title = get_sub_field('title');
                                    ...
                                    <div class="item p-4">
                                        <div class="head">
                                            <div class="organization">
                                                <img src="<?php echo the_field('z_organization_logo', $parent_id) ?>"
                                                    alt="<?
                                                            $logo_id = get_field('z_organization_logo', $parent_id, false);
                                                            $logo_alt = get_post_meta($logo_id, '_wp_attachment_image_alt', true);
                                                            echo $logo_alt;
                                                            ?>">
