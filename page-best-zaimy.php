	            ...
	            <div class="col-12">
	                <div class="credits__list">
		                      ...
		                      <?php 
								...
								if ( $query->have_posts() ):
									$io = 0;
								    while ( $query->have_posts() ): $query->the_post(); $best_id = get_the_id(); ?>
                                  ...
                                  <div class="best_offer position-relative" style="order: <?= $io; ?>">
                                    ...
                                    <div class="best_offer_button">
                                    	<?php if (get_field('card_bank_link', $best_id)): ?>
                                      	<a href="<?= get_field('card_bank_link', $best_id) ?>" target="_blank" onclick="<?= get_metrika_for_best_pages(get_field('card_bank_link', $best_id)); ?> return true;" class="btn btn-primary btn-block font-weight-normal best_offer_btn stretched-link">Получить деньги</a>
                                    	<?php else: ?>
                                      	<a href="<?php the_permalink($best_id); ?>" onclick="<?= get_metrika_for_best_pages(false); ?> return true;" class="btn btn-primary btn-block font-weight-normal best_offer_btn stretched-link">Получить деньги</a>
