...
<main>
    ...
    margin-top: 5px; " src="<?php bloginfo('template_url'); ?>/img/reshenie_main.png" alt="Решение"></div>
                ...
                <div class="col-12 col-md-5">
                    ...
                    <div class="credits__view-img">
                        ...
                        <div class="credits__view-buttons d-flex justify-content-center py-3 py-sm-4">
                            ...
                            <?php else: ?>
                                <a href="#" class="btn btn-light mx-3 <?php if ($apply_now) { ?> apply_now_btm <?php } else { ?>out_exit_link<?php } ?> " onclick="<?= get_metrika_for_detail_page(get_field('card_bank_link', $ID)) ?> return false;">Оформить сейчас</a>
                            <?php endif; ?>
        ...
        <?php if ($_GET['danil_test']): ?>
            ...
            <?php get_template_part('all_template/podborki__list', null, $title_term2); ?>
        ...
        <?php get_template_part('all_template/similar_list', null, ['TITLE' => 'Похожие ' . $title_term, 'DATA' => $featured_posts]); ?>
