...
<?php else: ?>
    ...
    //$cred_limit_ins = 1000000;
    //$cred_day_period_ins = 200;
    $cred_limit_ins = 0;
    $cred_day_period_ins = 0;
    if(isset($_SESSION['filter_installmentcard_card']) && !empty($_SESSION['filter_installmentcard_card'])):
    $mt = 1;
    $cred_limit_ins = $_SESSION['filter_installmentcard_card'][0];
    $cred_day_period_ins = $_SESSION['filter_installmentcard_card'][1];
    endif;
    unset($_SESSION['filter_installmentcard_card']);
    ?>
        ...
        <div class="container">
            <nav aria-label="breadcrumb" class="horizontal__scroll">
                <ol class="breadcrumb horizontal__scroll-container">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Карты рассрочки</li>
                </ol>
            </nav>
        </div>
        <div class="page__heading">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    <h1 class="page__heading-title mb-0">Карты рассрочки</h1>
                                    <?php $args = array(
                            'post_type'             => 'bankcard',
                            'posts_per_page'        => -1,
                            'orderby' => 'date',
        ...
        while ( $query->have_posts() ) {
         ...
         <?php } } wp_reset_query() ?>
                ...
                <div class="page__heading-description mt-2 mb-4">
                    В данном разделе вы можете оформить карту рассрочки по вашим финансовым возможностям
                </div>
                        ...
                        <div class="col-12 col-md-6 col-lg-3 col-xl-4 order-1">
                            <div class="range">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <input max="<?= $filter_price['install_inputs_range']['max']; ?>" type="text" class="range__value cred_limit" value="<?php echo $cred_limit_ins ?>" min="0">
                                </div>
                                <input max="<?= $filter_price['install_inputs_range']['max']; ?>" class="range__input" name="cred_limit" type="range" min="0" value="<?php echo $cred_limit_ins ?>">
                            </div>
                        </div>
                        <div class="col-12 col-md-6 col-lg-3 col-xl-4 order-2">
                            <div class="range">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <input max="<?= $filter_price['install_inputs_range']['day_max']; ?>" type="text" class="range__value cred_trat" value="<?php echo $cred_day_period_ins ?>" min="0">
                                </div>
                                <input max="<?= $filter_price['install_inputs_range']['day_max']; ?>" class="range__input" name="cred_day_period" type="range" min="0" value="<?php echo $cred_day_period_ins ?>">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-md-3 mb-3">
                            <a href="" class="tag__item tag__item-link d-flex align-items-center">
                                ...
                                <span class="tag__item-title">Топ 7 банков с выгодным процентом по вкладам</span>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="page__nav-container nav-tabs">
                    <div class="horizontal__scroll">
                        <div class="horizontal__scroll-container">
                            <a href="<?php echo get_term_link(8, '') ?>" class="nav-link active">Все карты рассрочки</a>
                            <a href="<?php echo get_page_link(4967); //1503 tax-reviews ?>" class="nav-link " data-tax="installmentcard">Отзывы</a>
                            ...
                            <a href="<?php echo get_page_link(1550) ?>" class="nav-link">сравнить</a>
                    ...
                    <div class="col-12 col-lg-4 order-lg-2">
                        <div class="sticky-top">
                            ...
                            <!--div class="filter mt-5 mb-3">
                                ...
                                'theme_location'  => 'sidebar_menu_installmentcard',
    ...
    <?php
                        ...
                        if ( $query_archive->have_posts() ): ?>
                            <h2 class="title archive_title mt-5">Архивные карты рассрочки (<?= $query_archive->found_posts; ?>)</h2>
            ...
            <div class="section">
                <div class="section__header mb-4 d-flex justify-content-between align-items-center">
                    <h2 class="title mb-0">Статьи о картах рассрочки</h2>
        ...
        <?php endif; ?>
            ...
            <div class="section">
                <div class="section__header d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="<?php echo  get_page_link(4967); //1503 tax-reviews ?>" class="btn btn-primary btn-sm btn-all" data-tax="installmentcard">
                        Все
                        <span class="icon ml-2">
                            <svg width="21" height="12" viewBox="0 0 21 12" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M1.242 5.266A.738.738 0 0 0 .5 6c0 .406.332.734.742.734H11.38v2.07c0 2.233 2.59 3.495 4.379 2.132l3.68-2.803a2.674 2.674 0 0 0 0-4.266l-3.68-2.803c-1.789-1.363-4.38-.1-4.38 2.132v2.07H1.243Zm13.612 4.507c-.813.62-1.99.046-1.99-.97V3.197c0-1.015 1.177-1.588 1.99-.969l3.68 2.804c.643.49.643 1.449 0 1.939l-3.68 2.803Z"></path></svg>
                        </span>
