...
if (isset($_GET['change_template']) && $_GET['change_template']):
    ...
    if (isset($_SESSION['filter_installmentcard_card']) && !empty($_SESSION['filter_installmentcard_card'])):
        $mt = 1;
        $cred_limit = $_SESSION['filter_installmentcard_card'][0];
        $cred_day_period = $_SESSION['filter_installmentcard_card'][1];
    endif;
    ...
    <main class="newlisting zaimy-new" term="installmentcard">
        ...
        <div class="page__heading">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    <h1 class="page__heading-title">Карты рассрочки</h1>
                </div>
                ...
                <div class="page__nav-container ">
                    <div class="horizontal__scroll">
                        <div class="horizontal__scroll-container-top">
                            <a href="#" class="nav-link-top active">Все карты рассрочки</a>
        ...
        <div class="container">
            ...
            <div id="reviews" class="section anchor">
                ...
                <a href="<?php echo  get_page_link(4967); //1503 tax-reviews 
                            ?>" class="btn btn-primary btn-sm btn-all-mob" data-tax="installmentcard">
                    Все
                    <span class="icon ml-2">
                        <svg width="21" height="12" viewBox="0 0 21 12" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M1.242 5.266A.738.738 0 0 0 .5 6c0 .406.332.734.742.734H11.38v2.07c0 2.233 2.59 3.495 4.379 2.132l3.68-2.803a2.674 2.674 0 0 0 0-4.266l-3.68-2.803c-1.789-1.363-4.38-.1-4.38 2.132v2.07H1.243Zm13.612 4.507c-.813.62-1.99.046-1.99-.97V3.197c0-1.015 1.177-1.588 1.99-.969l3.68 2.804c.643.49.643 1.449 0 1.939l-3.68 2.803Z"></path>
            ...
            <div id="news" class="section anchor">
                <div class="section__header mb-4 d-flex justify-content-between align-items-center">
                    <h2 class="title mb-0">Новости о картах рассрочки</h2>
