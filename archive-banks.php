    ...
    <div class="container">
        <nav aria-label="breadcrumb" class="horizontal__scroll">
            <ol class="breadcrumb horizontal__scroll-container">
                ...
                <li class="breadcrumb-item active" aria-current="page">Банки</li>
            </ol>
        </nav>
    </div>
    <!-- page header -->
    <div class="page__heading mb-4">
        <div class="container">
            <div class="page__heading-top d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="page__heading-title mb-0">Банки России</h1>
                </div>
                <div class="page__heading-icon"><img src="<?php bloginfo('template_url'); ?>/img/icon__title-shield.png" alt="Банки России"></div>
            </div>
        </div>
    </div>
    <!-- / page header -->
                                        ...
                                        <div class="reviews__item">
                                            <div class="reviews__item-body">
                                                <div class="reviews__header d-flex align-items-center mb-2">
                                                    <div class="reviews__header-logo"><img src="<?php echo the_field('bank_logo', $bank_id) ?>" alt="<?= get_post_meta(get_post_thumbnail_id(), '_wp_attachment_image_alt', true); ?>"></div>
                                ...
                                if (count($comments_list) > 0) {
                                    foreach ($comments_list as $comm) {
                                        ...
                                        <div class="reviews__item">
                                            <div class="reviews__item-body">
                                                <div class="reviews__header d-flex align-items-center mb-2">
                                                    <div class="reviews__header-logo"><img src="<?php echo the_field('bank_logo', $comment_post_id) ?>" alt="<?= get_post_meta(get_post_thumbnail_id(), '_wp_attachment_image_alt', true); ?>"></div>
                                                    <div class="reviews__header-meta ml-3">
...
*/
                                ...
                                if ($banks_table->have_posts()) : ?>
                                    ...
                                    <?php while ($banks_table->have_posts()) : $banks_table->the_post();
                                        $counter_banks += 1; ?>
                                        <tr class="<?php if ($counter_banks > 3): echo 'tr__hidden';
                                                    endif; ?>">
