...
<?php
$tax_id = 7; // Таксономия для дебетовых карт
$title_term1 = "Отзывы о дебетовых картах";
$title_term2 = "все дебетовые карты";
$calc_link = get_page_link(157);  // Страница калькулятора
$news_id = "13"; // ID категории для статей
        ...
        <div class="section">
            <div class="row reviews-page-list" id="reviews">
                ...
                if ($comments_list) {
                    ...
                    echo 'Нет отзывов для дебетовых карт.';
                }
                ?>
            </div>
