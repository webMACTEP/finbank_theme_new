						...
						<div class="code3text">
							...
							<?php if (get_field('opisanie_psk_1')): ?>
								...
								<div class="w30 td text-center">
									...
									<div class="td-val"><?php echo esc_html(get_field('opisanie_psk_1')); ?>% - <?php echo esc_html(get_field('opisanie_psk_2')); ?>%</div>
								</div>
						...
						<div class="code3text <?php if ($counter_prod > 10) echo 'div__hidden'; ?>">
							<div class="w30 strong td2">
								<a href="<?php the_permalink(); ?>" class="stretched-link" onclick="ym(35020350,'reachGoal','click_shortcode_sheet'); return true;">
									<img src="<?php echo esc_url(get_field('z_organization_logo')); ?>" alt="<?php the_title(); ?>">
									<?php the_title(); ?>
								</a>
							</div>
							<div class="td text-center">
							...
							<div class="td text-center">
								...
								<div class="td-val"><?php echo esc_html(get_field('z_history')); ?></div>
							</div>
							<div class="td text-center">
								<div class="hidden-lg">% ставка</div>
								<div class="td-val srok1">От <?php echo esc_html(get_field('z_stavka')); ?>%</div>
							</div>
							<div class="td text-center">
								<div class="hidden-lg">Срок</div>
								<div class="td-val">до <?php echo esc_html(get_field('z_time')); ?> дней</div>
							</div>
							<div class="td text-center">
								...
								<div class="rate3 text-center td-val">
									...
									<div><?php echo esc_html(get_field('ratings_average')); ?></div>
								</div>
							</div>
						</div>
					<?php 
				...
				<div class="code3"><span class="frecom">Финабанк рекомендует!</span>
					...
					while ($query->have_posts()) {
						...
						<div class="code3text">
							<div class="w30 strong td2">
								<a href="<?php the_permalink(); ?>" class="stretched-link" onclick="ym(35020350,'reachGoal','click_table_collection'); return true;">
									<img src="<?php echo esc_url(get_field('bank_logo', get_field('bank_choise', get_the_ID()))); ?>" alt="<?php the_title(); ?>">
									<?php the_title(); ?>
								</a>
							</div>
							<div class="td text-center">
							...
							<div class="td text-center">
								<div class="hidden-lg">% ставка</div>
								<div class="td-val srok1">От <?php echo esc_html(get_field('card_stavka')); ?>%</div>
							</div>
							<div class="td text-center">
								<div class="hidden-lg">Кэшбек</div>
								<div class="td-val srok1"><?php echo esc_html(get_field('card_cashback')); ?></div>
							</div>
							<div class="td text-center">
								<div class="hidden-lg">Стоимость</div>
								<div class="td-val srok1">От <?php echo esc_html(get_field('card_cost')); ?> ₽</div>
							</div>
							<div class="td text-center">
								<div class="hidden-lg">Рейтинг</div>
								<div class="rate3 text-center td-val">
					...
					while ($query->have_posts()) {
						...
						<div class="code3text">
							...
							<div class="td text-center">
								...
								<div class="td-val">до <?php echo esc_html(get_field('card_stavka_ostatok')); ?>%</div>
							</div>
							<div class="td text-center">
							...
							<div class="td text-center">
								...
								<div class="td-val srok1"><?php echo esc_html(get_field('card_overdraft')); ?></div>
							</div>
							<div class="td text-center">
								<div class="hidden-lg">Стоимость</div>
								<div class="td-val srok1"><?php echo esc_html(get_field('card_cost')); ?> ₽</div>
							</div>
							<div class="td text-center">
								<div class="hidden-lg">Рейтинг</div>
								<div class="rate3 text-center td-val">
