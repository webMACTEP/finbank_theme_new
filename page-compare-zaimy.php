...
<?php 
/*
$prods[0] = $_SESSION['zaimy'][0]; 
$prods[1] = $_SESSION['zaimy'][1]; 
$prods[2] = $_SESSION['zaimy'][2]; 
$prods[3] = $_SESSION['zaimy'][3]; 
*/

$prods = [];
foreach ($_SESSION['zaimy'] ?? [] as &$prod) {
    $prods[] = $prod;
}

$zaimy_count = count($prods);
?>

<main data-type="zaimy">
	<div class="container">
	...
	<div class="page__heading mb-sm-4">
	    <div class="container">
	        <div class="page__heading-top d-flex justify-content-between align-items-center">
	            <div>
	                <h1 class="page__heading-title mb-0">Сравнение займов</h1>
	            </div>
	            <div class="page__heading-icon"><img src="<?php bloginfo('template_url'); ?>/img/icon__title-hand.png" alt="Сравнение займов"></div>
	        </div>
	    </div>
	</div>
	<!-- / page header -->
	        ...
	        <div class="page__nav-container nav-tabs">
	            <div class="horizontal__scroll">
	                <div class="horizontal__scroll-container">
	                    <a href="<?php echo get_post_type_archive_link('zaimy') ?>" class="nav-link">Все займы</a>
	                    <a href="<?php echo get_page_link(1503) ?>" class="nav-link tax-reviews" data-tax="zaimy">Отзывы</a>
	                    ...
	                    <a href="<?php echo get_page_link(1554) ?>" class="nav-link active">сравнить</a>
	                </div>
	            </div>
	        </div>
	    </div>
	        ...
	        <div class="tags__main mb-5 pb-2 ">
	            <div class="horizontal__scroll">
	                <div class="horizontal__scroll-container">
	                    ...
	                    <a href="<?php echo get_page_link(1554) ?>" class="tag__item active"><span class="tag__item-title">займы 
	                    	<?php if(!empty($_SESSION['zaimy'])): ?>
	                    	<?php echo count($_SESSION['zaimy']) ?>
	                    	<?php else: echo '0'; endif; ?>
	                    	</span>
	                    </a>
	                    <a href="/zaimy/" class="tag__item tag__item__more">+ Добавить ещё</a>
	                </div>
	            </div>
	        </div>
	    </div>
	                ...
	                <div class="compare__list-container">   
	                    ...
	                    <div class="compare__list-header">
	                        <div class="compare__row">
	                            <?php if($prods[0] != ''): ?>
	                            <!-- item -->
	                            <?php $z_org = get_field('z_organization_logo', $prods[0]); ?>
	                            ...
	                            <?php if($prods[1] != ''): ?>
	                            <!-- item -->
	                            <?php $z_org = get_field('z_organization_logo', $prods[1]); ?>
	                            ...
	                            <?php if($prods[2] != ''): ?>
	                            <!-- item -->
	                            <?php $z_org = get_field('z_organization_logo', $prods[2]); ?>
	                            ...
	                            <?php if($prods[3] != ''): ?>
	                            <!-- item -->
	                            <?php $z_org = get_field('z_organization_logo', $prods[3]); ?>
