			...
			<div class="page__nav-container nav-tabs">
				<div class="horizontal__scroll">
					<div class="horizontal__scroll-container">
						...
						<a href="<?php echo get_page_link(5335) ?>" class="nav-link active">Карты рассрочки</a>
				...
				<div class="col-12">
					<div class="credits__list">
						...
						<div class="d-flex flex-wrap justify-content-between align-items-center mt-0 mt-md-5 mt-lg-0 mb-3">
							<div class="h2 mt-5 mb-4 mt-md-0 mb-md-0 special_hide"><span class="variants_count"><?= count(get_field('best-products')) ?></span> лучших карт рассрочки</div>
