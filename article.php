                    ...
                    <div class="article__one">
                        ...
                        <div class="article__one-header">
                            ...
                            <?php if ($date_actually): ?>
                                <div style="margin-left: 15px;" class="date_actually-article">Обновлено: <? //= $date_actually
                                        ...
                                        <div class="horizontal__scroll-item size3">
                                            <div class="offer__item">
                                                ...
                                                <div class="offer__item-footer mt-auto">
                                                    ...
                                                    <span
                                                        class="link-data btn btn-outline-main btn-block stretched-link"
                                                        data-link="<?= esc_attr($card_bank_link); ?>"
                                                        onclick="<?= get_metrika_for_offers_in_article(get_field('card_bank_link')); ?>">
                                                        Оформить
                                                    </span>
                                                </div>
                                            </div>
                    ...
                    if ($wp_query->have_posts()) { ?>
                        ...
                        <div class="arcticle__title">
                            <div class="arcticle__title-icon">
                                <svg width="24" height="22" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 22" xml:space="preserve">
