		...
		<div class="page__heading">
			<div class="container">
				<div class="d-flex justify-content-between align-items-center">
					<h1 class="page__heading-title">Кредиты</h1>
				</div>

				<?php
				$type_desc_top = get_field('type_desc_top', 'options');
				if ($type_desc_top) :
				?>
					<!-- description -->
										...
										<div class="c-col-1">
											...
											<div class="calc__field">
												<div class="calc__field-wrap">
													...
													<input type="text" class="range__value form-control calc__input" value="1000000" min="0" max="40000000" data-field="limit">
													<input class="range__input calc__input" name="summ_limit" type="range" min="0" max="40000000" value="1000000" data-field="limit" style="--range-progress:10%;">
												</div>
											</div>
											<div class="calc__field d-flex">
												<div class="calc__field-wrap mt-3 mt-md-4 flex-grow-1">
													...
													<input type="text" class="range__value form-control calc__input" value="10" min="1" max="180" data-field="date">
													<input class="range__input calc__input" name="cred_summ_period" type="range" min="1" max="180" value="10" data-field="date" style="--range-progress:25%;">
												</div>
			...
			<div class="credits section">
				<div class="row">
					...
					if ($query->have_posts()) {
						...
						// Передаём пагинацию во внешний глобал (если нужно)
			...
			<div class="section">
				<div class="container">
					<div class="rating-footer client-rating" data-post-id="<?php echo get_the_ID(); ?>">
						...
						if (have_rows('additional_ratings_list', 'options')) :
							$additional_index = 0;
							while (have_rows('additional_ratings_list', 'options')) : the_row();
								$title = get_sub_field('title', 'options');
