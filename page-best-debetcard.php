	...
	<div class="page__heading mb-sm-4 special_hide">
		<div class="container">
			<div class="page__heading-top d-flex justify-content-between align-items-center">
				<div>
					<h1 class="page__heading-title mb-0">Лучшие предложения по дебетовым картам</h1>
				</div>
			...
			<div class="page__nav-container nav-tabs">
				<div class="horizontal__scroll">
					<div class="horizontal__scroll-container">
						<a href="<?php echo get_page_link(5331) ?>" class="nav-link">Займы</a>
						...
						<a href="<?php echo get_page_link(5337) ?>" class="nav-link active">Дебетовые карты</a>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="col-12">
					<div class="credits__list">
						...
						<div class="d-flex flex-wrap justify-content-between align-items-center mt-0 mt-md-5 mt-lg-0 mb-3">
							<div class="h2 mt-5 mb-4 mt-md-0 mb-md-0 special_hide"><span class="variants_count"><?= count(get_field('best-products')) ?></span> лучших дебетовых карт</div>
							<div class="credits__list-dropdown dropdown mb-3 mb-md-0 col-12 col-md-5 col-lg-3 px-0">
								<select name="" class="styledSelect best1-order-select">
									...
									<option value="card_cost" <?= ($order == 'card_cost') ? $selected : ''; ?>>По обслуживанию</option>
									<option value="card_stavka_ostatok" <?= ($order == 'card_stavka_ostatok') ? $selected : ''; ?>>По проценту на остаток</option>
								</select>
							</div>
						</div>
						...
						<div class="best1_offers">
							...
							switch ($order) {
								...
								case 'views':
									...
									break;
								case 'card_cost':
									$args['meta_key'] = 'card_cost';
									$args['orderby'] = array('meta_value_num' => 'asc', 'name' => 'desc');
									$args['order'] = 'ASC';
									break;
								case 'card_stavka_ostatok':
									$args['meta_key'] = 'card_stavka_ostatok';
									$args['orderby'] = array('meta_value_num' => 'desc', 'name' => 'desc');
									$args['order'] = 'ASC';
									break;
								default:
									...
									<div class="best1_offer position-relative" style="order: <?= $io; ?>">
										...
										<div class="best1_offer_params">
											<div class="best1_offer_param">
												<div class="best1_offer_param_label">Снятие без %</div>
												<div class="best1_offer_param_value">до <?= get_field('non_pecent_money', $best_id) ?> ₽</div>
											</div>
											<div class="best1_offer_param">
												<div class="best1_offer_param_label">% на остаток</div>
												<?php if (get_field('card_stavka_ostatok', $best_id) == 0): ?>
													<div class="best1_offer_param_value"><?= get_field('card_stavka_ostatok', $best_id); ?>%</div>
												<?php else: ?>
													<div class="best1_offer_param_value">до <?= get_field('card_stavka_ostatok', $best_id); ?>%</div>
												<?php endif; ?>
											</div>
											<div class="best1_offer_param">
												<div class="best1_offer_param_label">Кэшбэк</div>
												<div class="best1_offer_param_value"><?php $field = get_field('card_cashback', $best_id);
																						echo $field['label'] ?></div>
											</div>
											<div class="best1_offer_param">
												<div class="best1_offer_param_label">Обслуживание</div>
												<?php if (get_field('card_cost', $best_id) == 0): ?>
													<div class="best1_offer_param_value"><?= get_field('card_cost', $best_id) ?> ₽</div>
												<?php else: ?>
													<div class="best1_offer_param_value">до <?= get_field('card_cost', $best_id) ?> ₽</div>
												<?php endif; ?>
											</div>
										...
										<div class="best1_offer_button">
											...
											<?php if ($card_bank_link): ?>
												<span
													class="link-data btn btn-primary btn-block font-weight-normal best1_offer_btn stretched-link"
											...
											<?php else: ?>
												<span data-popap-apply-id="<?php echo esc_attr(get_the_ID()); ?>"
													...
													class="btn btn-primary btn-block font-weight-normal best1_offer_btn stretched-link">
													Подобрать
												</span>
