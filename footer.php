                  ...
                  <?php while( have_rows('menu_1', 'option') ): the_row(); 
                      ...
                      <?php if($counter == 8): ?>
                        <div class="footer__services-item show__all btn__view-all visible">
                              <svg width="26" height="5" viewBox="0 0 26 5" xmlns="http://www.w3.org/2000/svg"><circle cx="3" cy="2.5" r="2.5"></circle><circle cx="13" cy="2.5" r="2.5"></circle><circle cx="23" cy="2.5" r="2.5"></circle></svg>
                          </div>
                      <?php endif; ?>
...
?>
  ...
  ?>
   ...
   $arr_best_pages_templates = ['page-best-zaimy.php','page-best-kredity.php',
       'page-best-creditcard.php', 'page-best-installmentcard.php','page-best-debetcard.php' ];
  ...
  <script>
    ...
    /*
    comebackUrl = 'https://www.google.ru/search?q=<?= $titlepage; ?>'; 
