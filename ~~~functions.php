...
function myown_comment($comment, $args, $depth)
{
						...
						while ($query->have_posts()) {
							...
							<div class="code3text">
								...
								<div class="w30  td text-center">
									...
									<div class="td-val"><?= number_format(get_field('credit_min_sum'), 0, '.', ' '); ?> - <?= number_format(get_field('credit_max_sum'), 0, '.', ' '); ?> ₽</div>
								</div>
								...
								<? if (get_field('opisanie_psk_1')): ?>

									<div class="w30  td text-center">
										<div class="hidden-lg">ПСК</div>
										<div class="td-val"><?php echo the_field('opisanie_psk_1') ?>% - <?php echo the_field('opisanie_psk_2') ?>% </div>
									</div>
	...
	//    if ( 'zaimy' === $queried_object->taxonomy ) {
	//        // Remove the prefix.
