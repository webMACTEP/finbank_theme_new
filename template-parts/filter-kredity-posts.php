       <?php $query__card = ''; if (get_field('archive') != true) $query__card = 'query__card';?>
        <?php $bank_id = get_field('product_bank'); ?>
       <?php $apply_now = get_field('apply_now_select_products', get_the_id()); ?>
       <?php
        $ID = get_the_id();
       ?>
        <div data-id="<?=  get_the_id(); ?>" class="123 card card__horizontal mb-4 <?= $query__card; ?>">
         ...
         <div class="card-container d-flex flex-wrap">
             ...
             <div class="card__footer mb-md-3 flex-grow-1 order-3 order-md-2">
                 <p>
                     ...
                     <a href="tel:<?= preg_replace('![^0-9]+!', '', get_field('bank_phone', $bank_id)); ?>"><?php echo the_field('bank_phone', $bank_id)  ?></a> 
                        <?php //echo the_field('bank_phone', $bank_id) ?></span>
                     <span class="mr-2 mr-md-5">
                     ...
                     <span class="mr-2 mr-md-5">Лицензия: <?php echo the_field('bank_license', $bank_id) ?></span>
             ...
             <div class="row flex-grow-1 order-2 order-md-3">
                 ...
                 <div class="col-12 col-md-6 col-lg-7">
                     <div class="row">
                         <div class="col-12 col-md-7">
                             <div class="card__field my-1">
                                 ...
                                 <!--span class="card__field-num"><?php echo the_field('credit_max_sum') ?> ₽</span-->
                                 <span class="card__field-num"><?= number_format(get_field('credit_max_sum'), 0, '.', ' '); ?> ₽</span>
                                 
                             </div>
                             <div class="card__field my-1">
                                 <span class="card__field-title">Мин. сумма</span> 
                                 <span class="card__field-num"><?= number_format(get_field('credit_min_sum'), 0, '.', ' '); ?> ₽</span>
                             </div>
                             <div class="card__field my-1">
                                 <span class="card__field-title">% ставка</span> 
                                 <span class="card__field-num">От <?php echo the_field('credit_stavka') ?>%</span>
                             </div>
                         </div>
                         <div class="col-12 col-md-5">
                             <div class="card__field my-1">
                                 <span class="card__field-title">Возраст:</span> 
                                 <span class="card__field-num">От <?= get_field('credit_oldness'); ?> <?= YearTextArg(get_field('credit_oldness')); ?></span>
                             </div>
                             <div class="card__field my-1">
                                 <span class="card__field-title">Срок:</span> 
                                 <span class="card__field-num">до <?php $field = get_field('credit_period');
                                            //$value = $field['value'];
                             ...
                             <div class="card__field my-1">
                                 ...
                                 <span class="card__field-num"><?php echo the_field('credit_answer') ?></span>
                             </div>
                         </div>
                     </div>
                     ...
                     <div class="d-sm-flex flex-wrap justify-content-between align-items-center mt-3">
                         <a href="<?php the_permalink($bank_id); ?>" class="font-weight-semibold"><?php echo get_the_title($bank_id); ?></a>
