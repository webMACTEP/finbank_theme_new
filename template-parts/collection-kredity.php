					...
					<div class="col-12 col-md-6 col-lg-3 col-xl-4 order-2">
						<div class="range">
							<div class="d-flex justify-content-between">
								...
								<input max="<?php echo $filter_price['kredity_inputs_range']['day_max']; ?>" type="text" class="range__value cred_trat" value="<?php echo $cred_summ_period ?>" min="0">
							</div>
							<input max="<?php echo $filter_price['kredity_inputs_range']['day_max']; ?>" class="range__input" name="cred_summ_period" type="range" min="0" value="<?php echo $cred_summ_period ?>">
						</div>
					</div>
				...
				<div class="horizontal__scroll">
					<div class="horizontal__scroll-container">
						...
						<a href="<?php echo get_page_link(4973); //1503 tax-reviews 
									?>" class="nav-link " data-tax="kredity">Отзывы</a>
						<a href="<?php echo get_page_link(149) ?>" class="nav-link">Калькулятор</a>
						<a href="<?php echo get_category_link(37) //18 
				...
				<div class="<?= $class_list ?>">
					<div class="credits__list">
						<div class="d-flex flex-wrap justify-content-between align-items-center mt-0 mt-md-5 mt-lg-0 mb-3">
							...
							<div class="credits__list-dropdown dropdown mb-3 mb-md-0  px-0 show">
