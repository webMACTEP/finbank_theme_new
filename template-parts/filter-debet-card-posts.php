		...
		<?php $bank_id = get_field('bank_choise'); ?>
        ...
        <div class="card card__horizontal mb-4 <?= $query__card; ?>">
         <div class="card-container d-flex flex-wrap">
             <div class="card__header d-flex justify-content-between align-items-center mb-3 flex-grow-1 order-1">
                ...
                <?php endif; ?>                 
                 <a class="btn__compare <?php echo my_compare_btn(get_the_id()); ?> " data-id="<?php echo get_the_id() ?>" data-tax="<?php echo $term_slug = $terms[0]->slug; ?>">
                     ...
                     <div class="row">
                         <div class="col-12 col-md-7">
                             <div class="card__field my-1">
                                 ...
                                 <span class="card__field-num">до <?= number_format(get_field('non_pecent_money'), 0, '.', ' '); ?> ₽</span>
                             </div>
                             <div class="card__field my-1">
                                 <span class="card__field-title">% на остаток:</span> 
                                 <span class="card__field-num">до <?php echo the_field('card_stavka_ostatok') ?> %</span>
                             </div>
                             <div class="card__field my-1">
                                 <span class="card__field-title">Кэшбэк:</span> 
                                 <span class="card__field-num"><?php $field = get_field('card_cashback');
                                            //$value = $field['value'];
                         ...
                         <div class="col-12 col-md-5">
                             <div class="card__field my-1">
                                 ...
                                 <span class="card__field-num"><?php echo the_field('card_overdraft') ?></span>
                             </div>
                             <div class="card__field my-1">
                                 <span class="card__field-title">Решение:</span> 
                                 <span class="card__field-num"><?php echo the_field('card_answ') ?></span>
                             </div>
                             <div class="card__field my-1">
                                 <span class="card__field-title">Стоимость:</span> 
                                 <span class="card__field-num"><?php echo the_field('card_cost') ?> ₽</span>
                             </div>
                         </div>
                     </div>
