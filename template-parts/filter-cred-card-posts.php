    ...
    <div class="card-container">
        <div class="item-content">
            ...
            <div class="item-buttons">
                ...
                <a class="btn__compare <?php echo my_compare_btn(get_the_id()); ?> btn btn-outline-primary btn-sm btn-icon d-flex align-items-center justify-content-center" data-id="<?php echo get_the_id() ?>" data-tax="creditcard">
