              ...
              <?php if (have_rows('bank-exit', 'option')): ?>
                <div class="exit1_offers">
                  <?php while (have_rows('bank-exit', 'option')) : the_row(); ?>
                    ...
                    $encoded_link3 = get_field('card_bank_link', $bank_exit_id);
                    $card_bank_link3 = base64_encode($encoded_link3);
                    ?>
                        ...
                        <div class="exit1_offer position-relative">
                          ...
                          <div class="exit1_offer_button">
                            ...
                            <?php if (get_field('card_bank_link', $bank_exit_id)): ?>
                              ...
                              <span
                                class="link-data btn btn-outline-primary btn-sm btn-block font-weight-normal exit1_offer_btn stretched-link"
                                data-link="<?= esc_attr($card_bank_link3); ?>"
                                onclick="<?= get_metrika_for_exit_popap_with_tag(get_field('card_bank_link', $bank_exit_id));  ?>">
                                Подробнее
                              </span>
                ...
                <div class="exit_offers">
                  <?php foreach ($mfos_exit as $mfo_exit): ?>
                    ...
                    <div class="exit1_offer position-relative">
                      <div class="exit1_offer_logo">
                        ...
                        <div class="exit1_offer_meta">
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <div class="position-relative card__icon d-flex align-items-center mr-3">
                              <div class="mr-2"><a href="<?php the_permalink($mfo_exit) ?>#comments" data-target="comments" class="stretched-link"><svg width="18" height="17" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 17" xml:space="preserve">
                                    <use xlink:href="<?php bloginfo('template_url'); ?>/img/icons.svg#commentLine" x="0" y="0"></use>
                                  </svg></a></div>
                              <?php $comments_count = wp_count_comments($mfo_exit);
                              echo $comments_count->approved ?>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="exit1_offer_button">
                        <?
                        $encoded_link = get_field('card_bank_link', $mfo_exit);
                        $card_bank_link2 = base64_encode($encoded_link);

                        ?>
                        <?php if (get_field('card_bank_link', $mfo_exit)): ?>
                          <span
                            class="link-data btn btn-primary btn-sm btn-block font-weight-normal exit1_offer_btn stretched-link"
                            data-link="<?= esc_attr($card_bank_link2); ?>"
                            onclick="<?= get_metrika_for_exit_popap(get_field('card_bank_link', $mfo_exit)); ?>">
                            Оформить
                          </span>
