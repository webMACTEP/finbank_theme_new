	...
	<div class="page__heading mb-sm-4 special_hide">
		<div class="container">
			<div class="page__heading-top d-flex justify-content-between align-items-center">
				<div>
					<h1 class="page__heading-title mb-0">Лучшие предложения по кредитам</h1>
				</div>
			...
			<div class="page__nav-container nav-tabs">
				<div class="horizontal__scroll">
					<div class="horizontal__scroll-container">
						...
						<a href="<?php echo get_page_link(5333) ?>" class="nav-link active">Кредиты</a>
				...
				<div class="col-12">
					<div class="credits__list">
						...
						<div class="d-flex flex-wrap justify-content-between align-items-center mt-0 mt-md-5 mt-lg-0 mb-3">
							<div class="h2 mt-5 mb-4 mt-md-0 mb-md-0 special_hide"><span class="variants_count"><?= count(get_field('best-products')) ?></span> лучших кредитов</div>
						...
						<div class="best1_offers">
							...
							if ($query->have_posts()):
								...
								while ($query->have_posts()): $query->the_post();
									$best_id = get_the_id();
									$best_bank_id = get_field('product_bank', $best_id) ?>
									...
									<div class="best1_offer position-relative" style="order: <?= $io; ?>">
										...
										<div class="best1_offer_params">
											...
											<div class="best1_offer_param">
												...
												<div class="best1_offer_param_value">до <?php $field = get_field('credit_period', $best_id);
