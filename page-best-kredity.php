                                  ...
                                  <div class="best1_offer position-relative" style="order: <?= $io; ?>">
                                    ...
                                    <div class="best1_offer_button">
                                    	<?php if (get_field('card_bank_link', $best_id)): ?>
                                      	<a href="<?= get_field('card_bank_link', $best_id) ?>" onclick="<?= get_metrika_for_best_pages(get_field('card_bank_link', $best_id)); ?> return true;" target="_blank" class="btn btn-primary btn-block font-weight-normal best1_offer_btn stretched-link">Оформить</a>
                                    	<?php else: ?>
